...
import TEPlayerStatsArray from "../data work/buildingTEDataset";

export default function TETable() {
  const [rowData, setRowData] = React.useState([]);

  React.useEffect(() => {
    setRowData(TEPlayerStatsArray);
  }, []);
  ...
  return (
    <div>
      <h1 className={styles.positionTitle}>TE</h1>
      <div
